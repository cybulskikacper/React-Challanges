...
export default function GameScreen(props) {
	const { pookachu, bombProps, doorDestroyed, escaped, gameStarted, setGameStarted } = props

	const moveOptions = [{ step: '/move2' }, { step: '/move3' }, { step: '/move1' }]
	...
	const image = `./src/assets/images/pookachu-sprites/${type}/${direction}${movement}.png`
			...
			<div className="game-screen-border">
				<div className={`game-screen ${screenClass}`}>
					...
					{bombProps.bomb.planted && (
						<Bomb bombData={bombProps.bomb} resetBomb={bombProps.resetBomb} checkDoor={bombProps.checkDoor} />
					)}
				</div>
			</div>
		</header>
