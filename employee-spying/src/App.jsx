...
export default function App() {
	...
	function handleInputChange(e) {
		...
		if (inputValue.includes('Evil Corp.')) {
			inputValue = inputValue.replace(/Evil Corp./g, 'Good Corp.')
		}
		...
		const newReport = {
			...
			infractionDetected: inputValue.includes('Evil Corp'),
		}
	...
	return (
		<div>
			<Header />
			<textarea placeholder="Write your report here..." value={userInput} onChange={handleInputChange} />
		</div>
	)
}
